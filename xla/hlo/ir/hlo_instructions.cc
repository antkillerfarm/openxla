...
HloAsyncStartInstruction::HloAsyncStartInstruction(
    ...
    : HloAsyncInstruction(opcode, shape, operands, async_computation) {
...
void HloAsyncStartInstruction::ClearAsyncComputationInstruction() {
  ...
  if (!called_computations().empty()) {
    CHECK_EQ(called_computations().front()->AsyncStart(), this);
    called_computations().front()->RemoveAsyncStart();
  }
}
